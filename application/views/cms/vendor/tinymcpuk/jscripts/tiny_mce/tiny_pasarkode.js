...
theme_advanced_buttons2 : "cut,copy,paste,insertfile,|,image,inserttime,media,youtubeIframe,|,charmap,|,hr,|,undo,redo,|,replace,search,preview,|,sub,sup,|,pagebreak,|,nonbreaking,|,fullscreen,advcode,|,syntaxhl",
...
function openKCFinder(field_name, url, type, win) {
    tinyMCE.activeEditor.windowManager.open({
       ...
       file: domain+'application/views/cms/vendor/kcfinder/browse.php?opener=tinymce&type=' + type,
        title: 'KCFinder',
        width: 700, 
        height: 500,
        resizable: "yes",
