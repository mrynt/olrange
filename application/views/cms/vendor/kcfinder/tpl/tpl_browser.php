...
<head>
<title>RedCMS: <?php echo $this->session['dir'] ?></title>
...
<div id="status"><span id="fileinfo" style="float:left; width:40%">&nbsp;</span> <a style="color:white;text-decoration:none" href="http://pasarkode.com">Powered by www.pasarkode.com</a></div>
</div>
</body>
</html>
